...
template <class READER, class WRITER> int
TRB_Asynch_RW_Stream_T<READER, WRITER>::read (ACE_Message_Block &message_block,
                            ...
                            int signal_number)
{
  ...
  return this->reader().read (message_block,
                              num_bytes_to_read,
                              act,
                              priority,
                              signal_number);
...
template <class READER, class WRITER> int
TRB_Asynch_RW_Stream_T<READER, WRITER>::write (ACE_Message_Block &message_block,
                             ...
                             int signal_number)
{
  ...
  return this->writer().write (message_block,
                               num_bytes_to_write,
                               act,
                               priority,
                               signal_number);
...
TRB_Asynch_RW_Dgram_T<READER, WRITER>::recv (ACE_Message_Block *  message_block,  
                 ...
                 int                  signal_number)
{
  ...
  return this->reader().recv (message_block,
...
template <class READER, class WRITER> ssize_t
TRB_Asynch_RW_Dgram_T<READER, WRITER>::send  (ACE_Message_Block * message_block,  
                 ...
                 int                 signal_number)
{
  ...
  return this->writer().send  (message_block,
